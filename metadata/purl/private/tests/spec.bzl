...
# TODO these 2 tests seems invalid according to spec and even per NPM type spec : https://github.com/package-url/purl-spec/blob/main/types/npm-definition.json#L16
#    {
...
#    },
    {
        "description": "valid npm purl without version and with subpath, scope encoded",
        "expected_failure": False,
        "expected_failure_reason": None,
        "expected_output": {
            "name": "core",
